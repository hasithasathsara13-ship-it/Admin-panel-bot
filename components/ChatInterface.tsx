    ...
    <div className="mx-auto flex h-full w-full max-w-full flex-1 flex-row overflow-hidden rounded-none border-0 shadow-none md:rounded-2xl md:border md:border-[var(--color-border-card)] md:shadow-[var(--shadow-card)]">
      ...
      >
        {activeConv ? (
          <>
            {/* Chat header */}
            <div className="flex h-[60px] min-w-0 shrink-0 items-center gap-2 overflow-x-hidden border-b border-[var(--color-border)] bg-[var(--color-surface-solid)] px-3 shadow-[var(--shadow-sm)] sm:gap-3 sm:px-4">
              <button
                type="button"
            ...
            {/* Input area */}
            <div className="shrink-0 flex flex-col bg-[var(--color-surface-solid)] border-t border-[var(--color-border)]">
